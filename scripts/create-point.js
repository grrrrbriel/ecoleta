...
document
     .querySelector("select[name = uf]") /* pegando o seletor de nome uf, ao colocar apenas "select" irá procurar pelo primeiro select da página */
...
function handleSelectedItem(event) {
    ...
    itemLi.classList.toggle("selected") /* add = adicionar, remove = remover, toggle = adicionar ou remover uma classe */
